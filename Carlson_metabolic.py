...
def Tension2(D, *params):
    ...
    gradP_tot = (Pres - 11.9) * 133.33 # Pressure converted from mmHg to N/m^2 by multiplying with 133.33 
...
while(k<len(Diameter_la)):
    gradP_tot = (Pressure_in[k] - 11.9) * 133.33 # Pressure converted from mmHg to N/m^2 by multiplying with 133.33
